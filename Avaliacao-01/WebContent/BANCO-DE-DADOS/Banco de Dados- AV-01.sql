...
drop Table Apuracao
drop Table Escola_de_Samba

Create Table Escola_de_Samba(id Int Identity Not Null Primary Key,nome Varchar(100),total_pontos Decimal (5,1))

Create Table Apuracao(id Int  Not Null Primary Key,id_jurado Int Not Null references Jurados (id),id_escola Int Not Null references 
Escola_de_Samba (id),id_Quesito Int Not Null references Quesito (id),nota_1 Decimal(5,1),nota_2 Decimal(5,1),nota_3 Decimal(5,1),
nota_4 Decimal(5,1),nota_5 Decimal(5,1),menor Decimal(5,1),maior Decimal(5,1),total Decimal(5,1))

Insert Into Escola_de_Samba Values('Acadêmicos do Tatuapé',0),('Acadêmicos do Tucuruvi',0),('Águia de Ouro',0),('Dragões da Real',0),
('Gaviões da Fiel',0),('Império de Casa Verde',0),('Mancha Verde',0),('Mocidade Alegre',0),('Nenê de Vila Matilde',0),('Rosas de Ouro',0),
('Tom Maior',0),('Unidos de Vila Maria',0),('Vai-Vai',0),('X-9 Paulistana',0)
